...
export const Register: React.FC = () => {
  ...
  const handleRegister = (e: React.FormEvent) => {
    e.preventDefault()
    alert('Solicitud enviada. La administración validará sus datos en un lapso de 24-48 horas.')
    navigate('/login')
  }
  ...
  const containerStyle: React.CSSProperties = { minHeight: '100vh', backgroundColor: 'var(--bg-color)', fontFamily: "'Inter', sans-serif", color: 'var(--text-color)', display: 'flex', flexDirection: 'column' }
  ...
  return (
    <div style={containerStyle}>
      <header style={headerStyle}>
        ...
        <h1 style={titleStyle}>Datos Residenciales</h1>
      </header>
      ...
      <main style={mainContentStyle}>
        ...
        <form onSubmit={handleRegister} style={cardStyle}>
          ...
          <button type="submit" style={primaryBtnStyle}>Enviar Solicitud</button>
        </form>
      </main>
    </div>
  )
