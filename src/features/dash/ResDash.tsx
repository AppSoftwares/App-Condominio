...
const headerStyle = { position: 'fixed' as any, top: 0, width: '100%', height: 'calc(60px + env(safe-area-inset-top))', backgroundColor: 'var(--header-bg)', borderBottom: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100, paddingTop: 'env(safe-area-inset-top)', boxSizing: 'border-box' as any }
const mainContentStyle = { paddingTop: 'calc(80px + env(safe-area-inset-top))', paddingLeft: '20px', paddingRight: '20px', width: '100%', maxWidth: '500px', margin: '0 auto', boxSizing: 'border-box' as any }
